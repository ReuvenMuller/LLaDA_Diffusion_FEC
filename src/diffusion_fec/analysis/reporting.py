...
SUMMARY_FIELDS = (
    ...
    "mean_actual_wire_packet_loss_rate",
    "mean_actual_data_packet_loss_rate",
    "mean_actual_repair_packet_loss_rate",
    "mean_actual_source_token_loss_rate",
    "mean_lost_position_recovery_rate",
    "mean_token_edit_distance",
    "known_position_preserved_rate",
    "mean_decode_latency_sec",
    "mean_total_decode_time_sec",
    "mean_model_forward_time_sec",
    "mean_candidate_construction_time_sec",
    "mean_parity_candidate_filter_time_sec",
    "mean_xor_peel_time_sec",
    "mean_linear_solver_time_sec",
    "mean_post_commit_hook_time_sec",
    "mean_rollback_time_sec",
    "mean_run_wall_time_sec",
    "mean_model_forward_calls",
    "mean_mean_candidate_count",
    "mean_max_candidate_count",
    ...
    "mean_linear_solver_tokens_recovered",
    "mean_iterative_peel_recovered_count",
    "mean_iterative_linear_solver_tokens_recovered",
    "mean_sparse_coverage_zero_count",
    "mean_sparse_actual_mean_degree",
    "mean_parity_hash_conflict_count",
    "mean_linear_solver_rank_deficient_count",
    "mean_linear_solver_validation_conflict_count",
    "mean_iterative_peel_hash_conflict_count",
    "mean_rollback_event_count",
    "mean_rollback_positions_count",
    "mean_rollback_banned_token_count",
    "mean_rollback_provenance_invalidated_count",
    "mean_rollback_total_steps_used",
    "mean_rollback_extra_steps_used",
    "mean_rollback_remaining_masks_after_budget",
    "rollback_adaptive_enabled_rate",
    "rollback_final_zero_masks_rate",
    "rollback_final_parity_clean_rate",
    "rollback_no_progress_stop_rate",
    "mean_parity_candidate_rejections",
    "mean_parity_filter_fallback_count",
    "mean_parity_filter_required_token_checks",
    "mean_parity_filter_full_scan_count",
    "mean_parity_filter_candidate_membership_checks",
    "mean_parity_filter_time_sec",
