...
def _case_summary_row(
    *,
    ...
    return {
        ...
        "rollback_adaptive_enabled": diagnostics.get("rollback_adaptive_enabled", ""),
        "rollback_total_steps_used": diagnostics.get("rollback_total_steps_used", ""),
        "rollback_base_steps": diagnostics.get("rollback_base_steps", ""),
        "rollback_extra_steps_used": diagnostics.get("rollback_extra_steps_used", ""),
        "rollback_stopped_reason": diagnostics.get("rollback_stopped_reason", ""),
        "rollback_final_zero_masks": diagnostics.get("rollback_final_zero_masks", ""),
